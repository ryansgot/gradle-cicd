...
version = "0.0.1"
val artifactId = "gradle-cicd-git"
...
fsPublishingConfig {
    ...
    description = "Gradle tasks that incorporate git and gradle to perform CI/CD related tasks like versioning, tagging, and committing"
...
bintray {
    ...
    pkg.apply {
        repo = "maven"
        name = artifactId
        desc = "Gradle tasks that incorporate git and gradle to perform CI/CD related tasks like versioning, tagging, and committing"
